...
class SegwayRMP400CorpChassisPhysicsClass(morse.core.robot.MorsePhysicsRobotClass):
    ...
    def __init__(self, obj, parent=None):
        ...
        self.wheelFLPos=mathutils.Vector((-0.305, 0.286, 0.270))
        self.wheelFRPos=mathutils.Vector((0.305, 0.286, 0.270))
        self.wheelRLPos=mathutils.Vector((-0.305, -0.286, 0.270))
        self.wheelRRPos=mathutils.Vector((0.305, -0.286, 0.270))
